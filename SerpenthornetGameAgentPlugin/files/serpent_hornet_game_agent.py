...
class SerpenthornetGameAgent(GameAgent):
    ...
    def _process_ocr(self, game_frame):
        # print(self.game.screen_regions["HUD_HEART_15"])
        # heart = serpent.cv.extract_region_from_image(game_frame.frame, self.game.screen_regions["HUD_HEART_2"])
        # print(heart[:, :, 0])
        ...
        return pytesseract.image_to_string(score_image,  lang='chi_sim', boxes=False,
